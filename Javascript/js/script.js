 ...
 * Le JavaScript possède des mots "réservés" qu'on ne peut utilisé pour créé un variable(ex: var, alert, ...).
 */
...
/**
 * En javascript le signe égal(=) n'est pas un opérateur d'égalité mais un opérateur d'affectation càd qu'il sert à affecter(ou assigner) une valeur à une variable et non que la variable est égal à sa valeur. Ainsi on va pouvoir affecter différentes valeurs à une même variable dans le temps.
 */
 ...
 * /!\ Attention: en programmation on utuilise des notations anglo-saxonne, ce qui signifie qu'il faut remplacer nos virgule par des points pour les nombres décimaux.
 */
var number = 25;
var number2 = -15;
var number3 = 1.09;
 ...
 * Pour affecter une une chaîne de caractère à une variable il faut l'entourer avec des guillemets ou apostrophes.
 */
 ...
 * pour affecter un boolean à une variable on utilise ni guillemet, ni apostrophe.
 */
var vrai = true;
var faux = false;
...
/**
 * Les autres types
 * Parmi les autres valeurs possible on peut citer la valeurs "null", qui correspond à la non connaissance à priori de la valeur. "undefined", qui coresspond au fait de ne pas avoir défini de valeur pour notre variable. "NaN" qui signifie "Not a Number" soit n'est pas un nombre
 */
var n = null,
u = undefined,
nn = NaN;
